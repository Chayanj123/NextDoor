...
<span class='nextdoor-class-footer'><a href="homepage.php">NexTDooR</a></span>
        ...
        <!-- <span class="navbar-brand-new">
            <a href="homepage.php">
                <img id='img-nav' src="images/nextDoor-logo.png" alt="nextdoor img" />
            </a>
        </span> -->
    ...
    <div style="margin-top: 100px" class="home-button">
        <a class="home-button-inside" href="homepage.php">Home</a>
    </div>

    <div class='body-center'>
        <h1 class='h1-body'>New in electronics</h1>

        <div class='padding-card-2 card-flex'>
            <div class='card-design-home'>
                <img class='image-card' src="images/iphone(electronics).jpg" alt="asd" />
                <hr />
                <div class='card-div'>
                    <h3 class='card-text'>phone</h3>
                    <p class='card-text-p'>17000/-</p>
                </div>
            </div>
